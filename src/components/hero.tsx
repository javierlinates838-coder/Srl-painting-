...
export function Hero() {
  ...
  return (
    <section className="mesh-dark relative overflow-hidden pt-[4.5rem] text-white">
        ...
        <div className="grid items-center gap-14 lg:grid-cols-2 lg:gap-16">
          <div>
            <div className="reveal pill text-zinc-300">
              <span className="h-1.5 w-1.5 rounded-full bg-brand-light shadow-[0_0_8px_#f43f5e]" aria-hidden />
            ...
            <div className="reveal reveal-d3 mt-6 flex flex-wrap gap-2">
              {serviceAreas.map((a) => (
                <span
                  key={a.city}
          ...
          <div className="reveal reveal-d2 float">
            <div className="relative">
              <div className="absolute -inset-4 rounded-3xl bg-gradient-to-br from-brand/40 via-transparent to-brand-light/20 blur-2xl" aria-hidden />
              <BeforeAfterSlider
