              ...
              <Reveal key={faq.q} as="li" delay={(i % 4) as 0 | 1 | 2 | 3}>
                <div>
                  ...
                  >
                    ...
                    <span
                      aria-hidden
                      className={`mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center text-lg leading-none ${
                  ...
                  {isOpen && (
                    <div id={panelId} role="region" aria-labelledby={buttonId} className="pb-5">
                      <p className="max-w-2xl text-[15px] leading-relaxed text-muted">{faq.a}</p>
                    </div>
                  )}
                </div>
              </Reveal>
