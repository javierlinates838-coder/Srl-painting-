      ...
      <div className="container-main">
        ...
        <div className="relative mt-14">
          ...
          <ol className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {process.map((step, i) => (
              <Reveal key={step.num} as="li" delay={(i + 1) as 1 | 2 | 3 | 4}>
                <div className="card-lift group relative overflow-hidden rounded-2xl border border-black/6 bg-white p-7 shadow-sm">
                  <div
