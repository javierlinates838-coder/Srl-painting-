export const site = {
  ...
  heroHeadline: "Color that lasts under California sun.",
  heroDescription:
    "Interior, exterior, commercial, and cabinet work — licensed C-33 craft across Kern County and Los Angeles.",
  license: "1108313",
